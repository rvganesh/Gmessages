package com.rvg.tutorialview.object;
...
import com.rvg.tutorialview.view.AbstractTutorialView;
...
public class Tutorial implements Parcelable , TutorialInterface {
    ...
    public static final Creator<Tutorial> CREATOR
            = new Creator<Tutorial>() {
