package com.rvg.tutorialview.view;
...
import com.rvg.tutorialview.R;
import com.rvg.tutorialview.TutorialInterface;
import com.rvg.tutorialview.TutorialViewInterface;
import com.rvg.tutorialview.WalkThroughInterface;
import com.rvg.tutorialview.object.Tutorial;
...
/*
    ...
    private Runnable tutorialInfoViewPost = new Runnable() {
        @Override
        public void run() {
            LayoutParams gotItButtonParams = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
